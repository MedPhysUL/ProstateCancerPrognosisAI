...
from constants import (
    ...
    LEARNING_TABLE_PATH,
    MASKS_PATH,
    MSKCC_LEARNING_TABLE_PATH,
    MSKCC_HOLDOUT_TABLE_PATH,
    NOMOGRAMS_PATH,
    TABLE_TASKS
)
...
if __name__ == "__main__":
    ...
    nomogram_dataframe.save_outer_splits_dataframes(
        path_to_folder=os.path.join(NOMOGRAMS_PATH, "MSKCC"),
        masks=masks,
    ...
    nomogram_dataframe = NomogramDataframe(table_dataset=table_dataset)
    nomogram_dataframe.save_outer_splits_dataframes(
        path_to_folder=os.path.join(NOMOGRAMS_PATH, "CAPRA"),
        masks=masks,
    ...
    # CUSTOM
    nomogram_dataframe.save_outer_splits_dataframes(
        path_to_folder=os.path.join(NOMOGRAMS_PATH, "CUSTOM"),
        masks=masks
    )
    nomogram_dataframe.save_final_dataframe(
        path_to_folder=os.path.join(NOMOGRAMS_PATH, "CUSTOM"),
