...
if __name__ == '__main__':
    ...
    model = SequentialNet(
        ...
        n_layers={PN_TASK.name: 3, BCR_TASK.name: 1, METASTASIS_TASK.name: 1, HTX_TASK.name: 1, CRPC_TASK.name: 3, DEATH_TASK.name: 2},
        n_neurons={PN_TASK.name: 15, BCR_TASK.name: 20, METASTASIS_TASK.name: 15, HTX_TASK.name: 15, CRPC_TASK.name: 15, DEATH_TASK.name: 20},
        features_columns={
    ...
    import json
    path = r'C:\Users\Labo\Desktop\temporary_save_folder\preds\split_1\SeqNet.json'
