...
if __name__ == '__main__':
    ...
    model = SequentialNet(
        ...
        n_layers={PN_TASK.name: 3, BCR_TASK.name: 3, METASTASIS_TASK.name: 2, HTX_TASK.name: 2, CRPC_TASK.name: 3, DEATH_TASK.name: 1},
        n_neurons={PN_TASK.name: 20, BCR_TASK.name: 15, METASTASIS_TASK.name: 10, HTX_TASK.name: 10, CRPC_TASK.name: 15, DEATH_TASK.name: 15},
        features_columns={
    ...
    import json
    path = r'C:\Users\Labo\Desktop\temporary_save_folder\preds\split_3\SeqNet.json'
