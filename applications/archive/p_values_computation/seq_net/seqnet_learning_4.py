...
if __name__ == '__main__':
    ...
    model = SequentialNet(
        ...
        n_layers={PN_TASK.name: 3, BCR_TASK.name: 2, METASTASIS_TASK.name: 3, HTX_TASK.name: 2, CRPC_TASK.name: 1, DEATH_TASK.name: 1},
        n_neurons={PN_TASK.name: 20, BCR_TASK.name: 10, METASTASIS_TASK.name: 15, HTX_TASK.name: 10, CRPC_TASK.name: 20, DEATH_TASK.name: 15},
        features_columns={
    ...
    import json
    path = r'C:\Users\Labo\Desktop\temporary_save_folder\preds\split_4\SeqNet.json'
