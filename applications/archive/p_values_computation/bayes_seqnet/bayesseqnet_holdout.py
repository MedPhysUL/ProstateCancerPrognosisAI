...
if __name__ == '__main__':
    ...
    state = torch.load(r"C:\Users\Labo\Documents\GitHub\ProstateCancerPrognosisAI\applications\local_data\records\experiments\HOLDOUT\DEATH(BayesSeqNet - Clinical data only)\best_model_checkpoint.pt")["model_state"]
    ...
    import json
    path = r'C:\Users\Labo\Desktop\temporary_save_folder\preds\holdout\BayesSeqNet.json'
