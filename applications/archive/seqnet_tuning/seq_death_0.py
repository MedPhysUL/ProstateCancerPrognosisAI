...
if __name__ == '__main__':
    ...
    config_dict = get_model_configs_dictionary(
        path_to_outer_splits_folder={
            ...
            CRPC_TASK: r"C:\Users\maxen\Documents\GitHub\ProstateCancerPrognosisAI\applications\local_data\records\experiments\CRPC(SeqNet - Clinical data only)\outer_splits"
        },
        n_outer_loops=5,
        n_inner_loops=5
    )
    ...
    model_hyperparameter = TorchModelHyperparameter(
        ...
        parameters={
            ...
            "features_columns": {
                ...
                DEATH_TASK.name: [c.column for c in CLINICAL_CONTINUOUS_FEATURES] + [c.column for c in CLINICAL_CATEGORICAL_FEATURES]
            },
