...
if __name__ == '__main__':
    ...
    models = {
        PN_TASK.name: "PN(SeqNet - Clinical data and automatic radiomics)",
        BCR_TASK.name: "BCR(SeqNet - Clinical data and deep radiomics)",
        METASTASIS_TASK.name: "METASTASIS(SeqNet - Clinical data only)",
        HTX_TASK.name: "HTX(SeqNet - Clinical data only)",
        CRPC_TASK.name: "CRPC(SeqNet - Clinical data only)"
    }
    configs = {}
    ...
    model = SequentialNet(
        ...
        n_neurons={PN_TASK.name: 10, BCR_TASK.name: 10, METASTASIS_TASK.name: 0, HTX_TASK.name: 10, CRPC_TASK.name: 10, DEATH_TASK.name: 10},
        features_columns={
