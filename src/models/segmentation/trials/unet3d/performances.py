...
if __name__ == '__main__':
    ...
    # Defining Transforms
    trans = Compose([
        AddChanneld(keys=['CT', 'Prostate_segmentation']),
    ...
    net.load_state_dict(torch.load('C:/Users/rapha/Documents/GitHub/ProstateCancerPrognosisAI/applications/local_data/unet3d/runs/exp01/best_model_parameters.pt'))
    net.eval()
