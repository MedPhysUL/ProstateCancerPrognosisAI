"""
    @file:              eval_performances.py
    @Author:            Raphael Brodeur

    @Creation Date:     03/2022
    @Last modification: 03/2023

    @Description:       This file contains a script to assess the performance of ProstateNet.
"""
...
if __name__ == "__main__":
    ...
    net.load_state_dict(torch.load(f"C:/Users/rapha/Documents/GitHub/ProstateCancerPrognosisAI/src/models/segmentation/net/prostate_net/saved_parameters/{best_parameters}"))
    net.eval()
    ...
    with torch.no_grad():
        for batch in val_loader:
            ...
            y_pred = net(batch_images)                  # Prediction
        ...
        with torch.no_grad():
            for patient in val_loader:
                ...
                if patient_idx == np.argmax(metric_list):
                    ...
                    y_pred = net(patient_img)               # Prediction
