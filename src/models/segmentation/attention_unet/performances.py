...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load('C:/Users/CHU/Documents/GitHub/ProstateCancerPrognosisAI/applications/local_data/attention_unet/runs/exp5/best_model_parameters.pt'))
    net.eval()
    ...
    writer = SummaryWriter(log_dir='C:/Users/CHU/Documents/GitHub/ProstateCancerPrognosisAI/applications/local_data/attention_unet/runs/exp5')
    with torch.no_grad():
