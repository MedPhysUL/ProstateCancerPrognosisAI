...
class TabularRadiomicsMLP(TorchModel):
    ...
    def build(self, dataset: ProstateCancerDataset) -> TabularRadiomicsMLP:
        """
        ...
        self.mlp = FullyConnectedNet(
            in_channels=self.cnn.n_features + len(dataset.table_dataset.features_cols),
