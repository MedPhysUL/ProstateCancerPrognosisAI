...
class EpochState(BaseState):
    ...
    _SUFFIX_WITH_REGULARIZATION = "with_regularization"
    _SUFFIX_WITHOUT_REGULARIZATION = "without_regularization"
    ...
    def set_losses_from_batches_state(self, batches_state: BatchesState, training: bool):
        ...
        for algo_name, v in batches_state.multi_task_losses_without_regularization.items():
            ...
            for loss_name, loss_value in v.items():
                multi_task_losses[algo_name][f"{loss_name}_{self._SUFFIX_WITHOUT_REGULARIZATION}"] = loss_value
                ...
                if batches_state.multi_task_losses_with_regularization:
                    ...
                    multi_task_losses[algo_name][f"{loss_name}_{self._SUFFIX_WITH_REGULARIZATION}"] = loss_with_reg
